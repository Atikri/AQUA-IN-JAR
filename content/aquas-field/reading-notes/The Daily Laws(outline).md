...
To add a link to a specific date, find the corresponding line in the HTML list below.
Change <li>Month Day</li> to <li><a href="YOUR_LINK_HERE">Month Day</a></li>
Example: <li>January 1</li> becomes <li><a href="https://example.com">January 1</a></li>
-->
